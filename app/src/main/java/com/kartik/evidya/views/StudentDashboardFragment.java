...
import com.example.chatapp.databinding.FragmentStudentDashboardBinding;
import com.example.chatapp.handler.StudentDashboardClickhandler;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link StudentDashboardFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StudentDashboardFragment extends Fragment {
    FragmentStudentDashboardBinding binding;
    StudentDashboardClickhandler handler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        handler = new StudentDashboardClickhandler(getActivity(),binding,getArguments());
        handler.loader();
