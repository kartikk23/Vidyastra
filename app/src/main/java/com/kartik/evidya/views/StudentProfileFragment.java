...
import com.example.chatapp.handler.StudentProfileClickHandler;
...
public class StudentProfileFragment extends Fragment {
    ...
    StudentProfileClickHandler handler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        handler = new StudentProfileClickHandler(getActivity(),binding,getArguments());
        handler.loader();
